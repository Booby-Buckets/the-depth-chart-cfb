...
export default function PlayerCharting({ ch, name }: { ch: PlayerChart; name: string }) {
  ...
  return (
    <section style={{ padding: "28px 0 8px" }} id="charting">
      <div className="sec-h">
        <h2>Charting</h2>
      ...
      {qb && (
        <>
          <div className={c.tiles}>
            ...
            <Tile k="Air yards" v={qb.airYds} sub={`of ${qb.yds} passing yds`} />
      ...
      {rc && (
        <>
          <div className={c.tiles}>
            <Tile k="Targets" v={rc.att} sub={`${rc.comp} caught (${Math.round((rc.comp / rc.att) * 100)}%)`} />
            ...
            <Tile k="Air yards caught" v={rc.airYds} sub={`of ${rc.yds} receiving yds`} />
